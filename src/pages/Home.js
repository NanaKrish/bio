...
const Home = () => {
    return (_jsxs("div", { style: { minHeight: '100vh', backgroundColor: '#f8fafc' }, children: [_jsx("div", { style: {
                    ...
                    zIndex: 1
                        ...
                        zIndex: 2
                    } }) }), _jsx("div", { className: "relative z-10", style: { paddingTop: '80px' }, children: _jsx("div", { className: "max-w-6xl mx-auto px-6 py-12", children: _jsxs("div", { className: "space-y-12", children: [_jsxs("div", { className: "fade-in flex flex-col sm:flex-row items-start gap-8", children: [_jsx("div", { className: "flex-shrink-0", children: _jsxs("div", { className: "relative", children: [_jsx("div", { className: "w-56 h-72 bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-xl overflow-hidden shadow-2xl", children: _jsx("img", { src: "/NK.png", alt: "Krishna Narayanan", className: "w-full h-full object-cover hover:scale-105 transition-transform duration-700" }) }), _jsx("div", { className: "absolute inset-0 rounded-xl ring-1 ring-inset ring-black/10" })] }) }), _jsxs("div", { className: "flex-1 space-y-4 pt-4", children: [_jsx("h1", { className: "home-name", style: {
                                                    fontSize: '3rem',
                                                    fontWeight: '200',
                                                    color: 'white',
